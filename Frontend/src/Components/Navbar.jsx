...
export default function Navbar({LeftDraweropen,setLeftDraweropen}) {
    ...
    return (
        <AppBar sx={{width:"100%"}} position="sticky" >
                ...
                <FullBox >
                    <Box1 ><MenuIcon onClick={()=>{setLeftDraweropen(!LeftDraweropen),console.log(LeftDraweropen)}} style={{color:"white",marginRight:"1rem"}} /><Box1><YouTubeIcon/><Typography  sx={{ fontSize:"3rem","@media (max-width :522px)":{display:"none"}}}>YouTube</Typography></Box1></Box1>
                    <Box2><Searchbar placeholder='Search...' sx={{}}/><SearchIcon sx={{borderLeft:"1px solid gray",paddingLeft:"3px"}}/></Box2>
                    <Box3><VideoCameraBackIcon /><NotificationsIcon /><AccountCircleIcon /></Box3>
